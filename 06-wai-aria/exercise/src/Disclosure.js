...
class App extends React.Component {
  render() {
    return (
      <dl className="faq">
        <dt>
          <button aria-expanded={true} aria-controls="faq1_desc">
            What do I do if I have a permit for an assigned lot, but can't find
            a space there?
          </button>
        </dt>
        <dd>
          <p id="faq1_desc" className="desc">
            ...
            and call 999-999-9999 to report the problem. We will note and
            approve your alternate location and will investigate the cause of
            the shortage in your assigned facility.
          </p>
        </dd>
        <dt>
        ...
        <dd>
          <p id="faq2_desc" className="desc">
            ...
            a fee to replace your lost permit. However, if your permit was
            stolen, a copy of a police report needs to be submitted along with a
            stolen parking permit form for a fee replacement exemption.
          </p>
        </dd>
        <dt>
        ...
        <dd>
          <p id="faq3_desc" className="desc">
            ...
            exceptions are made for any holiday or recess except those
