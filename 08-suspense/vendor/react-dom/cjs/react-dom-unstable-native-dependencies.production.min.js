...
function m(a){for(var b=arguments.length-1,c="https://reactjs.org/docs/error-decoder.html?invariant="+a,f=0;f<b;f++)c+="&args[]="+encodeURIComponent(arguments[f+1]);l(!1,"Minified React error #"+a+"; visit %s for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ",c)}var n=null,p=null,q=null,r={injectComponentTree:function(a){n=a.getFiberCurrentPropsFromNode;p=a.getInstanceFromNode;q=a.getNodeFromInstance}};
function t(a){var b=a._dispatchListeners,c=a._dispatchInstances;Array.isArray(b)?m("103"):void 0;a.currentTarget=b?q(c):null;b=b?b(a):null;a.currentTarget=null;a._dispatchListeners=null;a._dispatchInstances=null;return b}function v(a){do a=a.return;while(a&&7!==a.tag);return a?a:null}function w(a,b,c){for(var f=[];a;)f.push(a),a=v(a);for(a=f.length;0<a--;)b(f[a],"captured",c);for(a=0;a<f.length;a++)b(f[a],"bubbled",c)}
function x(a,b){null==b?m("30"):void 0;if(null==a)return b;if(Array.isArray(a)){if(Array.isArray(b))return a.push.apply(a,b),a;a.push(b);return a}return Array.isArray(b)?[a].concat(b):[a,b]}function y(a,b,c){Array.isArray(a)?a.forEach(b,c):a&&b.call(c,a)}
function z(a,b){var c=a.stateNode;if(!c)return null;var f=n(c);if(!f)return null;c=f[b];a:switch(b){case "onClick":case "onClickCapture":case "onDoubleClick":case "onDoubleClickCapture":case "onMouseDown":case "onMouseDownCapture":case "onMouseMove":case "onMouseMoveCapture":case "onMouseUp":case "onMouseUpCapture":(f=!f.disabled)||(a=a.type,f=!("button"===a||"input"===a||"select"===a||"textarea"===a));a=!f;break a;default:a=!1}if(a)return null;c&&"function"!==typeof c?m("231",b,typeof c):void 0;
return c}function A(a,b,c){if(b=z(a,c.dispatchConfig.phasedRegistrationNames[b]))c._dispatchListeners=x(c._dispatchListeners,b),c._dispatchInstances=x(c._dispatchInstances,a)}function ca(a){a&&a.dispatchConfig.phasedRegistrationNames&&w(a._targetInst,A,a)}function da(a){if(a&&a.dispatchConfig.phasedRegistrationNames){var b=a._targetInst;b=b?v(b):null;w(b,A,a)}}
function B(a){if(a&&a.dispatchConfig.registrationName){var b=a._targetInst;if(b&&a&&a.dispatchConfig.registrationName){var c=z(b,a.dispatchConfig.registrationName);c&&(a._dispatchListeners=x(a._dispatchListeners,c),a._dispatchInstances=x(a._dispatchInstances,b))}}}function C(){return!0}function D(){return!1}
...
E.extend=function(a){function b(){}function c(){return f.apply(this,arguments)}var f=this;b.prototype=f.prototype;var e=new b;k(e,c.prototype);c.prototype=e;c.prototype.constructor=c;c.Interface=k({},f.Interface,a);c.extend=f.extend;F(c);return c};F(E);function ea(a,b,c,f){if(this.eventPool.length){var e=this.eventPool.pop();this.call(e,a,b,c,f);return e}return new this(a,b,c,f)}
function fa(a){a instanceof this?void 0:l(!1,"Trying to release an event instance into a pool of a different type.");a.destructor();10>this.eventPool.length&&this.eventPool.push(a)}function F(a){a.eventPool=[];a.getPooled=ea;a.release=fa}var G=E.extend({touchHistory:function(){return null}});function H(a){return"touchstart"===a||"mousedown"===a}function I(a){return"touchmove"===a||"mousemove"===a}function J(a){return"touchend"===a||"touchcancel"===a||"mouseup"===a}
var K=["touchstart","mousedown"],L=["touchmove","mousemove"],M=["touchcancel","touchend","mouseup"],N=[],O={touchBank:N,numberActiveTouches:0,indexOfSingleActiveTouch:-1,mostRecentTimeStamp:0};function P(a){return a.timeStamp||a.timestamp}function Q(a){a=a.identifier;null==a?m("138"):void 0;return a}
...
function U(a,b){null==b?m("29"):void 0;return null==a?b:Array.isArray(a)?a.concat(b):Array.isArray(b)?[a].concat(b):[a,b]}var V=null,W=0;function X(a,b){var c=V;V=a;if(null!==Y.GlobalResponderHandler)Y.GlobalResponderHandler.onChange(c,a,b)}
...
0<W&&"selectionchange"===a||H(a)||I(a))){var e=H(a)?Z.startShouldSetResponder:I(a)?Z.moveShouldSetResponder:"selectionchange"===a?Z.selectionChangeShouldSetResponder:Z.scrollShouldSetResponder;if(V)b:{var d=V;for(var g=0,h=d;h;h=v(h))g++;h=0;for(var u=b;u;u=v(u))h++;for(;0<g-h;)d=v(d),g--;for(;0<h-g;)b=v(b),h--;for(;g--;){if(d===b||d===b.alternate)break b;d=v(d);b=v(b)}d=null}else d=b;b=d===V;d=G.getPooled(e,d,c,f);d.touchHistory=T.touchHistory;b?y(d,da):y(d,ca);b:{e=d._dispatchListeners;b=d._dispatchInstances;
if(Array.isArray(e))for(g=0;g<e.length&&!d.isPropagationStopped();g++){if(e[g](d,b[g])){e=b[g];break b}}else if(e&&e(d,b)){e=b;break b}e=null}d._dispatchInstances=null;d._dispatchListeners=null;d.isPersistent()||d.constructor.release(d);e&&e!==V?(d=void 0,b=G.getPooled(Z.responderGrant,e,c,f),b.touchHistory=T.touchHistory,y(b,B),g=!0===t(b),V?(h=G.getPooled(Z.responderTerminationRequest,V,c,f),h.touchHistory=T.touchHistory,y(h,B),u=!h._dispatchListeners||t(h),h.isPersistent()||h.constructor.release(h),
u?(h=G.getPooled(Z.responderTerminate,V,c,f),h.touchHistory=T.touchHistory,y(h,B),d=U(d,[b,h]),X(e,g)):(e=G.getPooled(Z.responderReject,e,c,f),e.touchHistory=T.touchHistory,y(e,B),d=U(d,e))):(d=U(d,b),X(e,g)),e=d):e=null}else e=null;d=V&&H(a);b=V&&I(a);g=V&&J(a);if(d=d?Z.responderStart:b?Z.responderMove:g?Z.responderEnd:null)d=G.getPooled(d,V,c,f),d.touchHistory=T.touchHistory,y(d,B),e=U(e,d);d=V&&"touchcancel"===a;if(a=V&&!d&&J(a))a:{if((a=c.touches)&&0!==a.length)for(b=0;b<a.length;b++)if(g=a[b].target,
null!==g&&void 0!==g&&0!==g){h=p(g);b:{for(g=V;h;){if(g===h||g===h.alternate){g=!0;break b}h=v(h)}g=!1}if(g){a=!1;break a}}a=!0}if(a=d?Z.responderTerminate:a?Z.responderRelease:null)c=G.getPooled(a,V,c,f),c.touchHistory=T.touchHistory,y(c,B),e=U(e,c),X(null);return e},GlobalResponderHandler:null,injection:{injectGlobalResponderHandler:function(a){Y.GlobalResponderHandler=a}}};(0,r.injectComponentTree)(aa.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactDOMComponentTree);
module.exports={injectComponentTree:r.injectComponentTree,ResponderEventPlugin:Y,ResponderTouchHistoryStore:T};
